...
{{< card link="/2026/bilder" title="Bilder" icon="user" target="_blank" >}}
{{< /cards >}}

### Paarungen aller Runden

{{< cards >}}
{{< card link="/2026/runde/1" title="Paarungen Runde 1" icon="user" >}}
{{< card link="/2026/runde/2" title="Paarungen Runde 2" icon="user" >}}
{{< card link="/2026/runde/3" title="Paarungen Runde 3" icon="user" >}}
{{< card link="/2026/runde/4" title="Paarungen Runde 4" icon="user" >}}
{{< card link="/2026/runde/5" title="Paarungen Runde 5" icon="user" >}}
{{< card link="/2026/runde/6" title="Paarungen Runde 6" icon="user" >}}
{{< card link="/2026/runde/7" title="Paarungen Runde 7" icon="user" >}}
{{< /cards >}}

### Rangliste aller Runden

{{< cards >}}
{{< card link="/2026/rangliste/1" title="Rangliste nach Runde 1" icon="user" >}}
{{< card link="/2026/rangliste/2" title="Rangliste nach Runde 2" icon="user" >}}
{{< card link="/2026/rangliste/3" title="Rangliste nach Runde 3" icon="user" >}}
{{< card link="/2026/rangliste/4" title="Rangliste nach Runde 4" icon="user" >}}
{{< card link="/2026/rangliste/5" title="Rangliste nach Runde 5" icon="user" >}}
{{< card link="/2026/rangliste/6" title="Rangliste nach Runde 6" icon="user" >}}
{{< card link="/2026/rangliste/7" title="Rangliste nach Runde 7" icon="user" >}}
{{< /cards >}}

### Auswertung

{{< cards >}}
{{< card link="/2026/spezial/dwz" title="DWZ Auswertung" icon="user" >}}
{{< /cards >}}
